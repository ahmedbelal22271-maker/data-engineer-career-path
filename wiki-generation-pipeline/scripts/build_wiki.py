...
SECTIONS = [
    ...
    ("storage", "Data Storage & Repositories", [
        ...
        ("Data Modeling & ERDs", "c4_data_modeling_and_erds.md", "storage"),
        ("SQL Data Types & Schema Design", "c4_sql_data_types_and_schema_design.md", "storage"),
        ("Keys, Indexes & Constraints", "c4_keys_indexes_and_constraints.md", "storage"),
        ("MySQL & PostgreSQL Hands-On", "c4_mysql_and_postgresql.md", "storage"),
    ...
    ("processing", "Big Data & Processing", [
        ...
        ("ETL Pipelines in Python", "c3_etl_pipelines_python.md", "processing"),
        ...
        ("Big Data Characteristics Deep Dive", "big_data_characteristics_deep_dive.md", "processing"),
        ("Cloud Computing & Distributed Systems", "cloud_computing_and_distributed_systems.md", "processing"),
        ...
        ("Streaming Data Platforms", "streaming_data_platforms.md", "processing"),
        ("Message Queues & RabbitMQ", "rabbitmq_message_queues.md", "processing"),
        ("AWS Big Data Ecosystem", "aws_big_data_ecosystem.md", "processing"),
    ]),
    ...
    ("python", "Python for Data Science", [
        ...
        ("File I/O & Working with Files", "c2_file_io.md", "python"),
        ...
        ("NumPy for Data Science", "c2_numpy.md", "python"),
        ("Pandas for Data Analysis", "c2_pandas.md", "python"),
        ("APIs & Data Collection", "c2_apis_data_collection.md", "python"),
        ("Web Scraping", "c2_web_scraping.md", "python"),
        ("File Formats in Python", "c2_file_formats_python.md", "python"),
        ("Python Dev Environment", "c3_python_ide_dev.md", "python"),
    ]),
