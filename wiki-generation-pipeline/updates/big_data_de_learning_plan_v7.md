...
**Target total:** ~262h (IBM track) + ~488h (supplements) + ~49h (post-track enhancements) = ~750h all-inclusive; realistically ~400–500h following the IBM track with selective supplements  
**Format:** 16 IBM courses in official order → 4 post-track enhancement modules → Appendices (certs + playlist index)  
**Use it as a menu:** Follow the IBM courses sequentially for the most structured path. Add supplements based on your weak areas. Complete Post-Track Enhancements after Course 16 for topics IBM doesn't cover (Hive/Impala, Apache Ranger/Atlas, dbt).
...
- v4 — 2026-06-25: Integrated **[IBM Data Engineering Professional Certificate](https://www.coursera.org/professional-certificates/ibm-data-engineering)** (16 Coursera courses) across the plan. IBM courses prioritized at the start of each relevant module. ~233h of IBM content integrated.
...
> 🎓 **[IBM Data Engineering Professional Certificate](https://www.coursera.org/professional-certificates/ibm-data-engineering)** — 16 courses · ~262h · Beginner level · IBM Skills Network Team, Romeo Kienzler, Joseph Santarcangelo
>
...
## IBM Track — Course 1: Introduction to Data Engineering (~24h total)
...
**Combined total: ~24h | IBM: 14h | Tier 1 supplements: 8h | Tier 2 supplements: 2h**
...
| [Spark — Structured Streaming Programming Guide](https://spark.apache.org/docs/latest/structured-streaming-programming-guide.html) | Official docs | 2 | Free |
...
| [freeCodeCamp — "ETL and Data Pipeline" concepts (search YouTube)](https://www.youtube.com/@freecodecamp) — search "ETL pipeline Python" for practical walkthroughs | YouTube | 3 | Free |
...
> **Tool choice note:** Airflow is the industry standard for orchestration. Alternatives (Prefect, Dagster, Mage) are worth knowing exist — [Prefect documentation](https://docs.prefect.io/) and [Dagster documentation](https://docs.dagster.io/) are both free to read — but do not split time across all of them during your first pass.

**Combined total: ~71h | IBM: 18h | Tier 1 supplements: 19h | Tier 2 supplements: 34h**
...
## IBM Track — Course 12: Introduction to Big Data with Spark and Hadoop (~90h total)
...
**Combined total: ~90h | IBM: 20h | Tier 1 supplements: 30h | Tier 2 supplements: 55h**
...
## IBM Track — Course 13: Machine Learning with Apache Spark (~58h total)
...
**Combined total: ~58h | IBM: 16h | Tier 1 supplements: 26h | Tier 2 supplements: 16h**
...
## IBM Track — Course 14: Data Engineering Capstone Project (~21h total)
...
**Combined total: ~21h | IBM: 18h | Tier 1 supplements: 3h | Tier 2 supplements: 0h**
...
> **Pacing notes:**
> - **IBM-Only path:** ~10h/week → ~34 weeks. The fastest way to get the IBM certificate.
> - **IBM + Core Supplements path:** ~10h/week → ~58 weeks (~14 months). Includes the highest-ROI supplements only; skips the deep-dive options.
...
| Courses 8–11 (Core DE) | ETL, DW, BI, NoSQL | 64h | 131h | ~195h |
| Courses 12–13 (Big Data & ML) | Spark, Hadoop, MLlib | 36h | 127h | ~163h |
| Course 14 (Capstone) | End-to-end project | 18h | 3h | ~21h |
| Courses 15–16 (Career & AI) | GenAI, interview prep | 24h | 82h | ~106h |
| **IBM Track Subtotal** | | **262h** | **439h** | **~701h** |
| Post-Track Enhancements | Hive/Impala/Pig, Ranger/Atlas, dbt, revision | — | 49h | ~49h |
| **Full Plan Total** | | **262h** | **488h** | **~750h** |
