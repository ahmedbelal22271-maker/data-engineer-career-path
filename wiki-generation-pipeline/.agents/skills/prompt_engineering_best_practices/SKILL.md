...
description: "Comprehensive guide to prompt engineering techniques for Claude's latest models (Fable 5, Mythos 5, Opus 4.8/4.7/4.6, Sonnet 4.6, Haiku 4.5). Covers clarity, XML structuring, examples, thinking/adaptive-thinking, tool use, agentic systems, output formatting, multi-context workflows, and migration from earlier models. Trigger whenever the task involves crafting or debugging prompts, designing system prompts, setting up agentic workflows, configuring thinking/effort parameters, migrating prompts between model generations, or optimizing tool use calling patterns."
---
...
- **Less verbose:** May skip verbal summaries after tool calls for efficiency unless prompted otherwise
