...
description: Fact-checking source and knowledge regarding Anthropic products.
---



# Source: anthropic-product-knowledge-skill.md
...
When orchestrating complex tasks, consult the [Agent Self-Knowledge Boundaries](file:///C:/Users/marwa/OneDrive/Documents/College%20Courses/agentic%20workflow/general%20tips/.agents/skills/anthropic_product_knowledge/references/self_knowledge_boundaries.md) protocol to mathematically verify tool availability and correctly handle transient vs. authorization failures.
